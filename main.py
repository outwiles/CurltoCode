...
def Aashu16(Aashu1):
 ...
 for Aashu2,Aashu3 in Aashu1.items():
  Aashu4=Aashu3[0] if isinstance(Aashu3,tuple) else Aashu2
  ...
  with open(Aashu7,'w',encoding='utf-8') as Aashu8:
   Aashu8.write(Aashu3[1] if isinstance(Aashu3,tuple) else Aashu3)
...
def Aashu9():
 ...
 Aashu5=input().strip()
 if not Aashu5:
  print("No cURL provided.")
  return
 if Aashu5.startswith(("http://","https://")):
  Aashu5="curl '"+Aashu5+"'"
 try:
